...
//
//    fun getTmpCacheImage(context: Context, prefix: String, suffix: String): File {
...
//     * AAAAAAAAAAAAAA
//     */
//    fun getTmpImageFile(context: Context, prefix: String, suffix: String): File {
...
//        val storageDir: File = context.cacheDir//(Environment.DIRECTORY_PICTURES)!!
//        return File.createTempFile(
